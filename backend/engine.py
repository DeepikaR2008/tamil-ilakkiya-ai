        ...
        if record:
            ...
            return {
                ...
                "evidence": {
                    ...
                    "text_english": record.get("text_english") or "A, as its first of letters, every speech maintains; The Primal Deity is first through all the world's domains.",
                    "text_hindi": record.get("text_hindi") or "वर्णों में जैसे 'अ' प्रथम, है आदि सब संसार। वैसे ही जग के मूल में, आदिप्रभु करतार॥",
                    ...
                    "meaning_hindi": record.get("explanation_hindi") or "जैसे समस्त अक्षरों में 'अ' पहला अक्षर है, वैसे ही संपूर्ण सृष्टि में आदि भगवान (परमात्मा) प्रथम और प्रमुख हैं।",
        ...
        if record:
            ...
            return {
                ...
                "evidence": {
                    ...
                    "text_tamil": record["text_tamil"],
                    "text_english": record.get("text_english") or record.get("explanation_english") or "",
                    "text_hindi": record.get("text_hindi") or record.get("explanation_hindi") or "",
                    ...
                    "meaning_hindi": record.get("explanation_hindi") or "प्रकृति व धर्म का मंगलाचरण।",
        ...
        if record:
            ...
            return {
                ...
                "evidence": {
                    ...
                    "meaning_hindi": record.get("explanation_hindi") or "बौद्ध महाकाव्य मणिमेकलै के पद।",
            ...
            if record:
                ...
                return {
                    ...
                    "evidence": {
                        ...
                        "meaning_hindi": record.get("explanation_hindi") or "",
                        "title_english": record.get("title_english") or record.get("chapter_name") or "",
                        "title_hindi": record.get("title_hindi") or record.get("chapter_name") or "",
                        "poet_english": record.get("poet_english") or s_poets_en,
                        "poet_hindi": record.get("poet_hindi") or s_poets_hi,
...
def answer_query(
    ...
    evidence = {
        ...
        "text_tamil": top_record["text_tamil"],
        "text_english": top_record.get("text_english") or top_record.get("explanation_english") or "",
        "text_hindi": top_record.get("text_hindi") or top_record.get("explanation_hindi") or "",
        ...
        "meaning_hindi": top_record.get("explanation_hindi") or "",
        "title_english": top_record.get("title_english") or top_record.get("chapter_name") or "",
        "title_hindi": top_record.get("title_hindi") or top_record.get("chapter_name") or "",
        "poet_english": top_record.get("poet_english") or top_record.get("poet") or "",
        "poet_hindi": top_record.get("poet_hindi") or top_record.get("poet") or "",
        "section_english": top_record.get("section_english") or top_record.get("section") or "",
        "section_hindi": top_record.get("section_hindi") or top_record.get("section") or "",
